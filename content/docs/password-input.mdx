...
import code, { useCode } from '@/components/code/forms/password-input-code';
...
You can now import this component anywhere you need to use it.
  ...
  <DynamicCodeBlock lang={'tsx'} code={`import { PasswordInput } from '@/components/ui/bloom/password-input';`}/>
</Step>
<Step>
### Use

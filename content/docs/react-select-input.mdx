...
import BasicFormCode from "@/components/code/forms/react-select-forms/BasicCode";
...
{<PreviewTabs component={<BasicForm />} code={BasicFormCode} name={"react-select-input"}/>}

#### Async Select Component

{<PreviewTabs component={<AsyncForm />} code={AsyncFormCode} name={"react-select-input"}/>}

#### Creatable Select Component

{<PreviewTabs component={<CreatableForm />} code={CreatableFormCode} name={"react-select-input"}/>}

#### Async Creatable Select Component

{<PreviewTabs component={<AsyncCreatableForm />} code={AsyncCreatableFormCode} name={"react-select-input"}/>}
